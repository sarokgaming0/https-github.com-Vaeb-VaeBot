...
index.bannedLetters = [];
// index.bannedLetters = ['f', '𝓕', 'ғ', 'ƒ', '🇫', 'ꎇ', '₣', '𝐅', '🄵', '🅵', '𝔽', 'ｆ', 'ꜰ', 'ꊰ', '𝐟', '𝖋', 'Ⓕ', 'ʄ', '𝓯', '𝕗', 'Ŧ', '下', '𝙁', '千', '⒡', 'ɟ', '℉', 'ｷ', '𝔣', '𝐹', 'Ⅎ', 'ꟻ', 'ᶠ', '𝙵', 'ℱ', '𝔉', '𝗳', 'Ֆ', 'φ', 'এ', 'ফ', 'ᶂ', 'ᵮ', 'Ꝭ', 'ꞧ', '🅕', 'ꞙ', 'ꬵ', 'ꝭ', 'ꝷ', 'ﬀ', 'ꭍ', 'ﬁ', 'Ḟ', 'דּ', '~~r~~', '~~t~~'];
...
client.login("Nzc2MTgyOTY3MTIyMzk1MTk3.X6xKuA.aJkrNaoj6vtXjm88bz72ozWbEi8");
